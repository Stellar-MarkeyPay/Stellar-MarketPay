...
class CdnInvalidationService extends EventEmitter {
   ...
   */
  constructor({ cdnService, metricsRegistry = null, publicBaseUrl }: any = {}) {
    super();
   ...
   */
  buildTargets(jobId: any, parties: any) {
   ...
   */
  async handleContractEvent(eventType: any, jobId: any, { receivedAt = Date.now() } = {}) {
