 ...
 * @returns {Buffer}
 */
function buildVerificationProof(query: any) {
 ...
 */
function parseGitHubQuery(query: any) {
 ...
 */
function parseWebsiteQuery(query: any) {
  const parts = String(query || "").split(":");
 ...
 */
async function verifyGitHubCommit(query: any, httpClient = axios) {
 ...
 * @returns {Promise<Buffer>}
 */
async function verifyWebsiteStatus(query: any, httpClient = axios) {
 ...
 * @returns {Promise<Buffer>}
 */
async function verifyOracleQuery(oracleType: any, oracleQuery: any, httpClient = axios) {
