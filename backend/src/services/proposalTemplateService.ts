...
async function listTemplates(freelancerAddress: any) {
...
async function createTemplate({ freelancerAddress, name, content }: any) {
  validatePublicKey(freelancerAddress);
  ...
  const { rows: countRows } = await rawQuery<any>(
...
async function updateTemplate({ id, freelancerAddress, name, content }: any) {
  validatePublicKey(freelancerAddress);
  const fields = [];
...
async function deleteTemplate(id: any, freelancerAddress: any) {
  validatePublicKey(freelancerAddress);
