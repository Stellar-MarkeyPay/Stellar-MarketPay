...
function issueAdminToken(publicKey: any, twoFaVerified: any) {
...
router.post("/setup", verifyJWT, requireAdminRole, async (req: any, res: any, next: any) => {
  try {
...
router.post("/verify", verifyJWT, requireAdminRole, async (req: any, res: any, next: any) => {
  try {
    const { publicKey } = req.user;
...
router.get("/status", verifyJWT, requireAdminRole, async (req: any, res: any, next: any) => {
  try {
