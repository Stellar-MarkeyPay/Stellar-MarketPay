 ...
 */
router.post("/policies", requireAuth, async (req: any, res: any, next: any) => {
  try {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/policies", requireAuth, async (req: any, res: any, next: any) => {
  try {
    const ownerAddress = req.user.address;
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/policies/:id", requireAuth, async (req: any, res: any, next: any) => {
  try {
    const { id } = req.params;
    const ownerAddress = req.user.address;
    ...
    const result = await rawQuery<any>(query, [id, ownerAddress]);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post("/claims", requireAuth, async (req: any, res: any, next: any) => {
  try {
    ...
    const fileResult = await rawQuery<any>(fileQuery, [fileId, ownerAddress]);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/claims", requireAuth, async (req: any, res: any, next: any) => {
  try {
    const ownerAddress = req.user.address;
 ...
 */
router.get("/claims/:id", requireAuth, async (req: any, res: any, next: any) => {
  try {
    const { id } = req.params;
    const ownerAddress = req.user.address;
 ...
 *               error: "Claim 999 not found"
 */
router.post("/claims/:id/submit-proof", requireAuth, async (req: any, res: any, next: any) => {
  try {
    const { id } = req.params;
