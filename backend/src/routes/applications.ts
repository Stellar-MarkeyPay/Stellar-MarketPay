...
router.get("/job/:jobId", generalApplicationRateLimiter, async (req: any, res: any, next: any) => {
  try {
...
router.post("/", applicationRateLimiter, async (req: any, res: any, next: any) => {
  try {
...
router.post("/:id/reveal", applicationRateLimiter, async (req: any, res: any, next: any) => {
  try {
...
router.post("/:id/accept", applicationRateLimiter, async (req: any, res: any, next: any) => {
  try {
...
router.delete("/:id", applicationRateLimiter, async (req: any, res: any, next: any) => {
  try {
