...
router.get("/preferences", verifyJWT, async (req: any, res: any, next: any) => {
  try {
...
router.patch("/preferences", verifyJWT, async (req: any, res: any, next: any) => {
  try {
...
router.patch("/read-all", verifyJWT, async (req: any, res: any, next: any) => {
  try {
...
router.patch("/:id/read", verifyJWT, async (req: any, res: any, next: any) => {
  try {
...
router.get("/unsubscribe", async (req: any, res: any) => {
  ...
  function htmlPage(success: any, message: any) {
