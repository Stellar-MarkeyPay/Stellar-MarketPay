...
function requireDeveloperWallet(req: any, res: any, next: any) {
...
router.post("/keys", async (req: any, res: any, next: any) => {
  try {
...
router.delete("/keys/:id", async (req: any, res: any, next: any) => {
  try {
