...
router.get("/jobs", async (req: any, res: any, next: any) => {
  try {
...
router.get("/jobs/:id", async (req: any, res: any, next: any) => {
  try {
...
router.get("/freelancers/:publicKey", async (req: any, res: any, next: any) => {
  try {
