 ...
 */
router.post("/", verifyJWT, writeLimiter, async (req: any, res: any, next: any) => {
  try {
 ...
 *         $ref: '#/components/responses/TooManyRequests'
 */
router.get("/job/:jobId", verifyJWT, readLimiter, async (req: any, res: any, next: any) => {
  try {
 ...
 *         $ref: '#/components/responses/TooManyRequests'
 */
router.post("/invoice", verifyJWT, writeLimiter, async (req: any, res: any, next: any) => {
  try {
