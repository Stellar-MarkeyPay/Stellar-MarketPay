...
router.post("/email", verificationRateLimiter, async (req: any, res: any, next: any) => {
  try {
...
router.post("/email/confirm", async (req: any, res: any, next: any) => {
  try {
...
router.post("/phone", verificationRateLimiter, async (req: any, res: any, next: any) => {
  try {
...
// Verify phone OTP
router.post("/phone/confirm", async (req: any, res: any, next: any) => {
  try {
...
router.post("/id/submit", verificationRateLimiter, async (req: any, res: any, next: any) => {
  try {
