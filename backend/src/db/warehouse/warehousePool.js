...
const warehousePool = new Pool({
  ...
  port: Number(process.env.WAREHOUSE_DB_PORT || 5434),
  database: process.env.WAREHOUSE_DB_NAME || "marketplace_warehouse",
  user: process.env.WAREHOUSE_DB_USER || "warehouse",
