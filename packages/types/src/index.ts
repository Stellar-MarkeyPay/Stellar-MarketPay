...
export type TimeInvoiceStatus = "pending" | "approved" | "rejected";
export type BridgeChain = "evm" | "soroban";
export type BridgeTransferStatus = "pending" | "deposited" | "released" | "refunded" | "recovering";
