...
export const CLIENT_ADDRESS = "GCLIENTADDRESS1234567890EXAMPLEABCDEFGHIJKLMNOPQRSTUV";
export const FREELANCER_ADDRESS = "GFREELANCER1234567890EXAMPLEABCDEFGHIJKLMNOPQRSTUVWX";
