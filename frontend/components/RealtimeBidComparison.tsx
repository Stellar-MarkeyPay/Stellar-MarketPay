        ...
        {biddingPhase === "reveal" && revealedApplications.length > 0 && (
          <div className="flex items-center gap-4 text-sm">
            <div className="text-amber-800">
              Avg:{" "}
              <span className="font-mono text-market-400">{formatXLM(averageBid.toString())}</span>
            </div>
            <div className="text-amber-800">
              Range:{" "}
            ...
            return (
              <div
                ...
                className={`card transition-all duration-500 ${
                  isHighlighted ? "ring-2 ring-amber-400 bg-amber-500/5 animate-pulse" : ""
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-3">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <FreelancerTierBadge
                      tier={application.freelancerTier}
                  ...
                  <div className="flex items-center gap-3 sm:flex-shrink-0">
                    ...
                    <span
                      className={`text-xs px-2.5 py-1 rounded-full border ${badgeClass(application.status)}`}
                    >
                      {application.status}
                    </span>
                  </div>
                ...
                {application.prediction && (
                  <div className="mb-3">
                    <JobCompletionPredictionPanel prediction={application.prediction} compact />
                  </div>
                )}
